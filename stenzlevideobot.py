    ...
    [
        [
            InlineKeyboardButton(
                        "📽️ᴀᴅᴅ ᴛᴏ ɢʀᴏᴜᴘ📽️", url="https://t.me/Stenzle_Videobot?startgroup=true")
        ],
        [   
...
async def start_group(_, message):
    ...
    fuk = "<b>ᴩᴏɴɢ ᴍᴜꜱɪᴄ !</b>"
    await message.reply_photo(photo="https://telegra.ph/file/41e0fa6b5c15870f94b56.jpg", caption=fuk)
...
async def video_play(_, message):
    ...
    try:
        if chat_id in QUEUE:
            ...
            await message.reply_photo(photo="https://telegra.ph/file/4243945a1a75da258a50b.jpg", caption=caps)
            await m.delete()
        else:            
...
async def end(_, message):
    ...
    if chat_id in LIVE_CHATS:
        ...
        return await message.reply_text("» ᴘʟᴀʏ ᴇɴᴅᴇᴅ.")
...
async def pause(_, message):
    ...
    if chat_id in QUEUE:
        try:
            await app.pause_stream(chat_id)
            await message.reply_text("» ᴘᴏᴜsᴇᴅ ")
        except:
            await message.reply_text("» ᴛɪᴅᴀᴋ ᴀᴅᴀ ʏᴀɴɢ ᴅɪᴍᴀɪɴᴋᴀɴ.")
    else:
        await message.reply_text("» ᴛɪᴅᴀᴋ ᴀᴅᴀ ʏᴀɴɢ ᴅɪᴍᴀɪɴᴋᴀɴ.")
...
async def restart(_, message):
    ...
    if user_id != OWNER_ID:
        return
    await message.reply_text("» <i>ᴘʟs ᴡᴀɪᴛ ...ᴀᴘᴘ ɪs ʀᴇsᴛᴀʀᴛɪɴɢ...</i>")
